...
android {
    namespace = "com.financialtracker.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.financialtracker.app"
        minSdk = 21
        targetSdk = 34
        versionCode = 2
        versionName = "2.0"
    ...
    signingConfigs {
        getByName("debug") {
            ...
            keyAlias = "mypass"
            storePassword = "com.financialtracker.app"
            keyPassword = "com.financialtracker.app"
        }
        create("release") {
            keyAlias = "mypass"
            keyPassword = "ccom.financialtracker.app"
            storeFile = file("ID527.keystore")
            storePassword = "com.financialtracker.app"
